(() => {
    ...
    const mainSection = document.querySelector(".page__main-section");
    const tariffSection = document.querySelector(".page__fariff-palns");
    const verivicationSection = document.querySelector(".page__form");
    const pageDecor = document.querySelector(".page__decor");
