(() => {
    ...
    function menuInit() {
        if (document.querySelector(".header__button-box")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".header__button-box")) {
                bodyLockToggle();
    ...
    function initSliders() {
        if (document.querySelector(".why__slider")) new swiper_core_Swiper(".why__slider", {
            ...
            initialSlide: 2,
            navigation: {
                prevEl: ".why__button--left",
                nextEl: ".why__button--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".telegram__swiper")) new swiper_core_Swiper(".telegram__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            initialSlide: 2,
            navigation: {
                prevEl: ".telegram__button--left",
                nextEl: ".telegram__button--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
